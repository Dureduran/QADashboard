...
import { Send, Bot, User, FileText, CheckCircle2, ShieldCheck, Database } from 'lucide-react';
            ...
            {isTyping && (
                <div className="flex justify-start">
                    <div className="flex gap-2 items-center">
                        ...
                        <div className="text-xs text-slate-500 animate-pulse">Processing context...</div>
                    </div>
                </div>
            )}
        </CardContent>
