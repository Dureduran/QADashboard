        ...
        <CardContent className="space-y-6 text-slate-300 leading-relaxed text-sm md:text-base">
            ...
            <div className="mt-8 bg-slate-950/50 p-6 rounded-lg border border-slate-800">
                ...
                <ul className="list-disc pl-5 space-y-3">
                    ...
                    <li><strong className="text-emerald-400">Avoiding diminishing returns on mature routes:</strong> Mature high-volume routes and dense regional feeders already benefit from stable booking curves, strong pricing power, high load factors, and established competitive positioning — leaving limited incremental gains even with sophisticated RM.</li>
