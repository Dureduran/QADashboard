          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                ...
                <Tooltip formatter={(value: any) => [`$${(Number(value) / 1000).toFixed(1)}k`, undefined]} />
                <Legend />
                <Line type="monotone" dataKey="actual" name="Actual Rev" stroke="#8b0050" strokeWidth={2} dot={false} activeDot={{ r: 6 }} />
                <Line type="monotone" dataKey="forecast" name="Forecast" stroke="#64748b" strokeDasharray="5 5" strokeWidth={2} dot={false} activeDot={{ r: 5 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
